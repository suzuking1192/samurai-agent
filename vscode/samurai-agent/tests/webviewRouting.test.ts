...
describe('Webview Routing Integration', () => {
    ...
    beforeEach(() => {
        ...
        testWorkspaceRoot = path.join(os.tmpdir(), 'samurai-agent-test-routing', Date.now().toString());
    ...
    describe('Error Handling', () => {
        ...
        it('should handle missing DataStore gracefully', () => {
            ...
            const mockExtensionUri = { fsPath: '/mock/extension/path' };
            const providerWithoutWorkspace = new SamuraiAgentPanelWebviewViewProvider(mockExtensionUri as any);
            ...
            // Access the private method for testing
            (providerWithoutWorkspace as any).handleWebviewMessage(mockWebview, message);
    ...
    describe('End-to-End Routing Validation', () => {
        it('should correctly separate global and project settings persistence', () => {
            ...
            assert.strictEqual(globalResponse.payload.openaiApiKey, 'sk-e2e-global-key');
